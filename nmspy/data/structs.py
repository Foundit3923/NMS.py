...
from nmspy.data.mod_structs import cGcBinoculars
...
class cGcBinoculars(ctypes.Structure):
    ...
    @property
    def emode(self):
        return safe_assign_enum(nms_enums.eMode, self._mode)

cGcBinoculars._fields_ = [
    ("_padding0", ctypes.c_ubyte * 1912),
    ("MarkerModel", common.TkHandle),
    ("_mode", ctypes.c_int32),
    ("_padding1912", ctypes.c_ubyte * 80),
